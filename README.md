...
![A gif of Coin Collector being played](https://file.garden/ZhvFhTnnzDVjn5ib/gifs/demogif.gif "Coin Collector")
...
![A gif of Agar.io being played](https://file.garden/ZhvFhTnnzDVjn5ib/gifs/agario_footage.gif "Agar.io")
...
![A gif of Spore being played](https://file.garden/ZhvFhTnnzDVjn5ib/gifs/spore.gif "Spore")  
Figure 3: A gif of Spore in its cell stage being played

Another game that I took inspiration from was Cookie Clicker (Cookie Clicker, s.d.), a popular game playable both on browser and on steam. Cookie Clicker is a game with a simple gameplay loop where the player generates cookies for doing an action before using those cookies to buy upgrades that increase the amount of cookies they generate. This inspired me to implement a similar upgrade system into my game.

![A gif of Cookie Clicker being played](https://file.garden/ZhvFhTnnzDVjn5ib/gifs/cookie.gif "Cookie Clicker")
...
- new things started using
- raylib, unreal
- how approach new things

### User Testing

- graphs and stuff
- how users felt on first test
- show data
- how users felt on second test, or benchmark
- guided test or blind test

### Outcome

- youtube video of demonstrating game
- trailer if wanted
- link to itch.io
- anything important, test in incognito browser or on phone

#### Instructions to Run/Install

- how to install and run the game
- or how to interact with source code
- or how to make the game if weird toolchain

### Reflection

#### Research Effectiveness

- was research helpful
...
- what is guiding your interests
- what do i regret (everything)
...
- declare any ai used and what they were used for

- this ai used to alter following files
    - list models of ai used
    - list files modified

- declare asset packs, anything i didn't make and am using wow
(make sure im allowed to use it)